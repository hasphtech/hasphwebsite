    ...
    <section className="relative min-h-screen flex flex-col" style={{ paddingTop: 70 }}>
      ...
      <div className="flex-1 flex items-center justify-center relative z-10">
        <div className="w-full max-w-[800px] mx-auto px-6 md:px-16 text-center flex flex-col items-center">
          ...
          <motion.div {...fadeUp(0)} className="mb-8 md:mb-12">
            <span
              className="inline-flex items-center gap-[10px] px-5 py-2 rounded-full text-[11px] md:text-[12px] font-[400] tracking-[0.1em] uppercase text-[#b8f000]"
              style={{
          ...
          <motion.p
            {...fadeUp(0.25)}
            className="mt-6 md:mt-9 mb-10 md:mb-14 text-[16px] md:text-[18px] leading-[1.75] text-[#5a5a5a] font-[300] max-w-[540px]"
          >
          ...
          <motion.div {...fadeUp(0.4)}>
            <a
              href="#"
              className="inline-block px-8 md:px-11 py-4 bg-[#b8f000] text-[#0a0a0a] rounded-[6px] font-[700] text-[14px] tracking-[0.06em] uppercase transition-all duration-250 hover:-translate-y-1 select-none"
              style={{
      ...
      >
        {metrics.map(({ num, sup, label }) => (
          <div
            key={label}
            className="px-6 md:px-10 py-6 md:py-8 text-center transition-colors duration-300 hover:bg-[rgba(184,240,0,0.05)]"
            style={{ borderRight: '1px solid rgba(255,255,255,0.08)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}
          >
            <div className="font-bebas text-[36px] md:text-[48px] tracking-[0.05em] text-[#f2f2f0] leading-none">
              {num}<span className="text-[#b8f000]">{sup}</span>
            </div>
            <div className="text-[10px] md:text-[11px] tracking-[0.15em] uppercase text-[#5a5a5a] mt-[6px]">
              {label}
            </div>
          </div>
        ))}
