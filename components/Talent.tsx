    ...
    <section className="w-full overflow-hidden px-5 md:px-16 mb-[60px] md:mb-[120px]">
      ...
      >
        ...
        >
          ...
          <p className="text-[14px] md:text-[15px] leading-[1.75] text-[rgba(255,255,255,0.75)] font-[400] max-w-[360px] mb-8 md:mb-10">
          ...
          {roles.map((role, i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[13px] md:text-[15px] font-[600] text-[#0A0F1C] mb-[2px] truncate">{role.title}</div>
                <div className="text-[11px] md:text-[12px] text-[#94A3B8] truncate">{role.sub}</div>
              </div>
              ...
              <span
                ...
                style={
                  role.open
                    ...
                    : { background: 'transparent', color: '#94A3B8', border: '1px solid rgba(37,99,235,0.15)' }
                }
              >
                {role.status}
              </span>
